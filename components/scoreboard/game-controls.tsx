...
const tabActions: Record<TabId, ActionButton[]> = {
  ...
  out: [
    { action: "groundout", label: "ゴロ", sub: "ゴロアウト", color: "text-[#DC2626]", bgColor: "bg-[#FEF2F2]", activeBg: "active:bg-[#FEE2E2]" },
    { action: "flyout", label: "飛", sub: "フライ", color: "text-[#2563EB]", bgColor: "bg-[#EFF6FF]", activeBg: "active:bg-[#DBEAFE]" },
    { action: "lineout", label: "直", sub: "ライナー", color: "text-[#D97706]", bgColor: "bg-[#FFFBEB]", activeBg: "active:bg-[#FEF3C7]" },
  ...
  run: [
    { action: "stolen-base", label: "盗塁", sub: "盗塁成功", color: "text-[#16A34A]", bgColor: "bg-[#F0FDF4]", activeBg: "active:bg-[#DCFCE7]", disabled: (s) => !s.bases[0] && !s.bases[1] && !s.bases[2] },
    { action: "caught-stealing", label: "盗死", sub: "盗塁失敗", color: "text-[#DC2626]", bgColor: "bg-[#FEF2F2]", activeBg: "active:bg-[#FEE2E2]", disabled: (s) => !s.bases[0] && !s.bases[1] && !s.bases[2] },
    { action: "wild-pitch", label: "暴投", sub: "ワイルドピッチ", color: "text-[#D97706]", bgColor: "bg-[#FFFBEB]", activeBg: "active:bg-[#FEF3C7]", disabled: (s) => !s.bases[0] && !s.bases[1] && !s.bases[2] },
    { action: "passed-ball", label: "捕逸", sub: "パスボール", color: "text-[#D97706]", bgColor: "bg-[#FFFBEB]", activeBg: "active:bg-[#FEF3C7]", disabled: (s) => !s.bases[0] && !s.bases[1] && !s.bases[2] },
    ...
    { action: "runner-out", label: "走死", sub: "走塁アウト", color: "text-[#DC2626]", bgColor: "bg-[#FEF2F2]", activeBg: "active:bg-[#FEE2E2]", disabled: (s) => !s.bases[0] && !s.bases[1] && !s.bases[2] },
  ],
  other: [
    { action: "hit-by-pitch", label: "死球", sub: "デッドボール", color: "text-[#DC2626]", bgColor: "bg-[#FEF2F2]", activeBg: "active:bg-[#FEE2E2]" },
    { action: "dropped-third-strike", label: "振逃", sub: "振り逃げ", color: "text-[#8B5CF6]", bgColor: "bg-[#F5F3FF]", activeBg: "active:bg-[#EDE9FE]" },
    { action: "fielders-choice", label: "野選", sub: "フィルダースチョイス", color: "text-[#D97706]", bgColor: "bg-[#FFFBEB]", activeBg: "active:bg-[#FEF3C7]", disabled: (s) => !s.bases[0] && !s.bases[1] && !s.bases[2] },
    { action: "error", label: "失策", sub: "エラー", color: "text-[#D97706]", bgColor: "bg-[#FFFBEB]", activeBg: "active:bg-[#FEF3C7]" },
    { action: "catcher-interference", label: "打妨", sub: "打撃妨害", color: "text-[#6B7280]", bgColor: "bg-[#F3F4F6]", activeBg: "active:bg-[#E5E7EB]" },
    { action: "obstruction", label: "走妨", sub: "走塁妨害", color: "text-[#6B7280]", bgColor: "bg-[#F3F4F6]", activeBg: "active:bg-[#E5E7EB]", disabled: (s) => !s.bases[0] && !s.bases[1] && !s.bases[2] },
    { action: "offensive-interference", label: "守妨", sub: "守備妨害", color: "text-[#6B7280]", bgColor: "bg-[#F3F4F6]", activeBg: "active:bg-[#E5E7EB]", disabled: (s) => !s.bases[0] && !s.bases[1] && !s.bases[2] },
  ],
};
